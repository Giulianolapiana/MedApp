...
import { Settings, Stethoscope, Clock, HardDrive, ShieldCheck, BookOpen } from "lucide-react";
...
type TabId = "profesionales" | "especialidades" | "disponibilidad" | "backups";
  ...
  return (
    <div className="flex h-full flex-col space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-3 border-b border-white/5 pb-5">
        ...
        <h1 className="text-2xl font-bold font-[var(--font-display)] text-white">Configuración</h1>
      </div>
